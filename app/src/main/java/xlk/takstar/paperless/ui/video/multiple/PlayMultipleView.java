package xlk.takstar.paperless.ui.video.multiple;
 ...
 * @desc
 */
public class PlayMultipleView extends ViewGroup{
    private final String TAG = "CustomVideoView-->";
    private final Context cxt;
    private int widthMeasureSpec;
    private int heightMeasureSpec;
    private CustomVideoView.ViewClickListener mListener;
    private boolean isEnlarge;//当前是否是最大的界面
    private List<MyGLSurfaceView> shrinkSfvs = new ArrayList<>();
    List<Integer> resids = new ArrayList<>();
    private int largeResId = -1;

    public PlayMultipleView(Context context) {
        this(context, null);
    }

    public PlayMultipleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.cxt = context;
    }
    ...
    private void measureChild(int parentWidth, int parentHeight) {
        ...
        ViewGroup.LayoutParams params = new ViewGroup.LayoutParams(parentWidth, parentHeight);
        ViewGroup.LayoutParams params2_1 = new ViewGroup.LayoutParams(parentWidth / 2, parentHeight / 2);
        ViewGroup.LayoutParams params1_1 = new ViewGroup.LayoutParams(1, 1);
    ...
    private void layout4() {
        ...
        glSurfaceView1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mListener != null) {
        ...
        glSurfaceView2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mListener != null) {
        ...
        glSurfaceView3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mListener != null) {
        ...
        glSurfaceView4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mListener != null) {
    ...
    public void setViewClickListener(CustomVideoView.ViewClickListener listener) {
        mListener = listener;
    }
