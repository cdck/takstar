    ...
    public void onCreate() {
        ...
        registerActivityLifecycleCallbacks(new ActivityLifecycleCallbacks() {
            ...
            public void onActivityCreated(@NonNull Activity activity, @Nullable Bundle savedInstanceState) {
                ...
                LogUtil.i(TAG, "onActivityCreated " + activity.getClass().getName() + ",Activity数量=" + activities.size());
            }
...
//        QbSdk.initX5Environment(appContext, cb);
    ...
    private void initScreenParam() {
        ...
        LogUtil.i(TAG, "initScreenParam 屏幕大小=" + GlobalValue.screen_width + "," + GlobalValue.screen_height);
    }
